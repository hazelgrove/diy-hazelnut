...
let test_st16 = () => {
  ...
  let given: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Hazelnut.syn_action(ctx, (ze, t), a);
  let expected: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Some((RAp((Var("incr")),NEHole(Cursor(Var("incr")))), Arrow(Num,Num)));
  check(zexp_htyp, "same option(Hazelnut.Zexp.t)", given, expected);
};
...
let test_st17 = () => {
  ...
  let given: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Hazelnut.syn_action(ctx, (ze, t), a);
  let expected: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Some((RAp((Var("incr")),NEHole(RAp((Var("incr")),Cursor(EHole)))), Arrow(Num,Num)));
  check(zexp_htyp, "same option(Hazelnut.Zexp.t)", given, expected);
};
...
let test_st18 = () => {
  let ctx: typctx = TypCtx.singleton("incr", Hazelnut.Htyp.Arrow(Num,Num));
  let ze: Hazelnut.Zexp.t = RAp((Var("incr")),NEHole(RAp((Var("incr")),Cursor(EHole))));
  let t: Hazelnut.Htyp.t = Arrow(Num,Num);
  let a: Hazelnut.Action.t = Construct(Hazelnut.Shape.Lit(3));
  let given: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Hazelnut.syn_action(ctx, (ze, t), a);
  let expected: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Some((RAp((Var("incr")),NEHole(RAp((Var("incr")),Cursor(Lit(3))))), Arrow(Num,Num)));
  check(zexp_htyp, "same option(Hazelnut.Zexp.t)", given, expected);
};
...
let test_st19 = () => {
  let ctx: typctx = TypCtx.singleton("incr", Hazelnut.Htyp.Arrow(Num,Num));
  let ze: Hazelnut.Zexp.t = RAp((Var("incr")), NEHole(RAp((Var("incr")),Cursor(Lit(3)))));
  let t: Hazelnut.Htyp.t = Arrow(Num,Num);
  let a: Hazelnut.Action.t = Move(Parent);
  let given: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Hazelnut.syn_action(ctx, (ze, t), a);
  let expected: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Some((RAp((Var("incr")),NEHole(Cursor(Ap((Var("incr")),Lit(3))))), Arrow(Num,Num)));
  check(zexp_htyp, "same option(Hazelnut.Zexp.t)", given, expected);
};
...
let test_st20 = () => {
  let ctx: typctx = TypCtx.singleton("incr", Hazelnut.Htyp.Arrow(Num,Num));
  let ze: Hazelnut.Zexp.t = RAp((Var("incr")), NEHole(Cursor(Ap((Var("incr")),Lit(3)))));
  let t: Hazelnut.Htyp.t = Arrow(Num,Num);
  let a: Hazelnut.Action.t = Move(Parent);
  let given: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Hazelnut.syn_action(ctx, (ze, t), a);
  let expected: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Some((RAp((Var("incr")),Cursor(NEHole(Ap((Var("incr")),Lit(3))))), Arrow(Num,Num)));
  check(zexp_htyp, "same option(Hazelnut.Zexp.t)", given, expected);
};
...
let test_st21 = () => {
  let ctx: typctx = TypCtx.singleton("incr", Hazelnut.Htyp.Arrow(Num,Num));
  let ze: Hazelnut.Zexp.t = RAp((Var("incr")),Cursor(NEHole(Ap((Var("incr")),Lit(3)))));
  let t: Hazelnut.Htyp.t = Arrow(Num,Num);
  let a: Hazelnut.Action.t = Finish;
  let given: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Hazelnut.syn_action(ctx, (ze, t), a);
  let expected: option((Hazelnut.Zexp.t, Hazelnut.Htyp.t)) =
    Some((RAp((Var("incr")),Cursor(Ap((Var("incr")),Lit(3)))), Arrow(Num,Num)));
  check(zexp_htyp, "same option(Hazelnut.Zexp.t)", given, expected);
};
