...
let test_eeascl_2 = () => {
  ...
  let given: Hazelnut.Hexp.t = Hazelnut.erase_exp(ze);
  let expected: Hazelnut.Hexp.t = Asc(Lam("f",Num, NumLit(1)), Arrow(Num, Num));
  check(hexp_typ, "same Hazelnut.Hexp.t", given, expected);
};
...
let test_eelam_2 = () => {
  let ze: Hazelnut.Zexp.t =
    RLam("f", Num, LPlus(RPlus(NumLit(1), Cursor(NumLit(1))), NumLit(2)));
  let given: Hazelnut.Hexp.t = Hazelnut.erase_exp(ze);
  let expected: Hazelnut.Hexp.t =
...
let test_eeapl_1 = () => {
  let ze: Hazelnut.Zexp.t = LAp(Cursor(Lam("f", Num, NumLit(1))), Var("x"));
  let given: Hazelnut.Hexp.t = Hazelnut.erase_exp(ze);
...
let test_eeapl_2 = () => {
  ...
  let given: Hazelnut.Hexp.t = Hazelnut.erase_exp(ze);
  let expected: Hazelnut.Hexp.t = Ap(Lam("f", Num, Lam("g", Hole, EHole)), Var("x"));
  check(hexp_typ, "same Hazelnut.Hexp.t", given, expected);
};

let test_eeapr_1 = () => {
  let ze: Hazelnut.Zexp.t = RAp(Lam("f", Num, NumLit(1)), Cursor(Var("x")));
  let given: Hazelnut.Hexp.t = Hazelnut.erase_exp(ze);
  let expected: Hazelnut.Hexp.t = Ap(Lam("f", Num, NumLit(1)), Var("x"));
  check(hexp_typ, "same Hazelnut.Hexp.t", given, expected);
};
...
let test_eeapr_2 = () => {
  let ze: Hazelnut.Zexp.t =
    RAp(Lam("f", Num, NumLit(1)), LAsc(Mark(Cursor(NumLit(1)), Free), Hole)); // not real state, just test
  let given: Hazelnut.Hexp.t = Hazelnut.erase_exp(ze);
  let expected: Hazelnut.Hexp.t =
...
let test_eeplusl_2 = () => {
  let ze: Hazelnut.Zexp.t =
    LPlus(RLam("f", Num, RPlus(NumLit(1), Cursor(NumLit(2)))), Var("y"));
  let given: Hazelnut.Hexp.t = Hazelnut.erase_exp(ze);
  let expected: Hazelnut.Hexp.t =
...
let test_eemark_2 = () => {
  ...
  let given: Hazelnut.Hexp.t = Hazelnut.erase_exp(ze);
  let expected: Hazelnut.Hexp.t = Mark(Ap(Mark(Var("f"), Free), Var("x")), NonArrowAp);
  check(hexp_typ, "same Hazelnut.Hexp.t", given, expected);
};
